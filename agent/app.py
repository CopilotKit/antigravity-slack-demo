...
INSTRUCTIONS = os.environ.get(
    ...
    "- Show, do not transcribe. Restaurants go through show_restaurants and "
    "menus through show_menu, always, passing the backend tool's results "
    "through unchanged. Never write a list of restaurants or dishes as text: "
    "that strips the photos, prices and buttons people need. Once a card or "
    "table is posted, summarise in one line instead of repeating it.\n"
